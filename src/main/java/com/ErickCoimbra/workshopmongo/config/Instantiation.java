...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post (null,sdf.parse("21/03/2018"),"Partiu viagem","Vou viajar pra Sao Paulo Abraços",maria);
		Post post2 = new Post (null,sdf.parse("23/03/2018"),"Bom dia ","Acordi feliz hj",maria);
